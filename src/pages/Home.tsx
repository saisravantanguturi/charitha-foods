  ...
  return (
    <div className="flex flex-col gap-12 pb-12">
      ...
      <section className="relative w-full aspect-[16/9] sm:aspect-[21/9] md:h-[600px] overflow-hidden bg-primary">
        {slides.map((slide, index) => (
          ...
          >
            ...
            {/* CHANGE: object-contain ensures the WHOLE image is seen. 
                Using object-cover for desktop but switching logic slightly.
            */}
            <img 
              src={slide.image} 
              alt={slide.title} 
      ...
      <section className="bg-cream -mt-4 sm:-mt-8 relative z-20 max-w-7xl mx-auto w-full px-4">
        <div className="bg-white rounded-xl shadow-lg p-4 sm:p-8 grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
          {[
